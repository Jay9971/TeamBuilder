...
def remove_stop_words(input_dict):
    ...
    print("filtered keys two ", filtered_keys)
...
def run_script(ROW):
    print("running runscript function")
    ROW = int(ROW)
    ...
    if True:
        ...
        X = data.iloc[1:19, 2:]  # Features
        y = data.iloc[1:19]['teamScore'] # Target variable
        """
        ...
        print("weight dict ",sorted_word_weights)
