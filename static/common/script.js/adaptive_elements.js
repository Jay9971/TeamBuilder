...
function darkMode() {
  ...
  if (parseInt(window.location.search.substring(16,17)) === "0" || parseInt(window.location.search.substring(37,38)) === "1") {
    darkModeStatus = parseInt(window.location.search.substring(16,17));
  } else {
    darkModeStatus = 0;
  }
